...
app = Flask(__name__)
CORS(app)
app.config['SQLALCHEMY_DATABASE_URI'] = f'postgres://efemscpqmxlctp:4fbe8cae307b501ce9e0c84a5d08245586f9fe94971e752ab26a2c9a48722be2@ec2-54-170-90-26.eu-west-1.compute.amazonaws.com:5432/dq1dfkpr05s3r'
